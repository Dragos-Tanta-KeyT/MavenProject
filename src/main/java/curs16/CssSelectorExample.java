...
public class CssSelectorExample extends BaseTest{
	...
	/*	jse.executeScript("arguments[0].setAttribute('style', 'background:purple; border:4px solid red');"
				+ " arguments[1].setAttribute('style', 'background:purple; border:4px solid red')", 
				newReleases, 
				comingSoon);*/
